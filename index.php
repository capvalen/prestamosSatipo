...
<head >
	...
	<title>Bienvenido: CrediBalbin Sistema Préstamos</title>
		...
		<div class="col-md-12">
			<div class="wello login-box " style="color: #673ab7"  >
				<div class="row">
					...
					<div class="col-xs-8"><h3 class="text-center" style="margin-top: 10px;margin-bottom: 0px;">Préstamos</h3>
						<div class="text-center"><span >Web app de «Infocat» <strong>Local: Satipo</strong></span></div>
