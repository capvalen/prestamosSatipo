...
$sql = "SELECT pre.*, lower(concat(TRIM(c.cliApellidoPaterno), ' ', TRIM(c.cliApellidoMaterno), ', ', TRIM(c.cliNombres))) as cliNombres, c.cliDni, tp.tpreDescipcion, lower( concat(a.addrDireccion, ' ', a.addrNumero, ' ', d.distrito, ' - ', p.provincia )) as `direccion`, c.cliCelularPersonal
FROM `prestamo` pre
...
<div class="container-fluid">
	...
	<div class="row">
		<table class="table table-bordered">
			<thead>
			<tr> 
				<th class="text-center" colspan="5">CREDIBALVIN | <span>CR-<?= $idPresPost; ?></span></th>  
			</tr>
			<tr>
			...
			<tr> 
				<td colspan="5">Celular: <span class="mayuscula"><?php if($respuesta['cliCelularPersonal']==''){echo '-';}else{echo $respuesta['cliCelularPersonal'];} ?></span> </td>
			</tr>
			<tr> 
